...
<body>
    ...
    if ($significados[$color] == ""){

    echo "<tr><td> $personas[$i] </td> <td> $direcciones[$i]  </td> <td> $telefonos[$i] </td> <td> $cumpleaños[$i] </td> <td> $color </td> <td> No se encuentra el significado </td> </tr>"; 
